...
INSERT INTO public.formation_modules (id, formation_id, title, description, duration_hours, order_index) VALUES
  ...
  ('m3333333-3333-3333-3333-333333333333'::uuid, 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa'::uuid, 'Framework React', 'Développement d\'applications avec React', 80, 3),
...
-- Créer des créneaux d'emploi du temps (aujourd'hui et demain)
...
-- Créer des feuilles d'émargement pour aujourd'hui
