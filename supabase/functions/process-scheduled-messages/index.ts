...
function generateMessageEmailHtml(senderName: string, subject: string, recipientName: string): string {
  return `<!DOCTYPE html><html lang="fr"><head><meta charset="UTF-8"></head><body style="margin:0;padding:0;font-family:'Segoe UI',sans-serif;background:#f4f4f7;"><table width="100%" style="padding:40px 20px;"><tr><td align="center"><table width="600" style="background:#fff;border-radius:12px;box-shadow:0 4px 6px rgba(0,0,0,0.1);"><tr><td style="background:linear-gradient(135deg,#C084FC 0%,#A78BFA 50%,#E879F9 100%);padding:24px 40px;text-align:center;border-radius:12px 12px 0 0;"><img src="https://utjdigcdlwqztwmgoomv.supabase.co/storage/v1/object/public/email-assets/email-logo-landing.png" alt="Nectforma" width="52" height="58" style="display:block;margin:0 auto 10px;border:none;outline:none;" /><span style="color:#ffffff;font-size:18px;font-weight:700;letter-spacing:0.5px;font-family:'Segoe UI',Arial,sans-serif;">Nectforma</span></td></tr><tr><td style="padding:40px;"><p style="color:#374151;">Bonjour <strong>${recipientName}</strong>,</p><div style="background:#F3F4F6;border-left:4px solid #C084FC;padding:20px;border-radius:0 8px 8px 0;margin-bottom:24px;"><h2 style="color:#1F2937;font-size:18px;margin:0 0 12px;">📩 Nouveau message reçu</h2><p style="color:#4B5563;margin:0;"><strong>${senderName}</strong> vous a envoyé: "${subject}".</p></div><table width="100%"><tr><td align="center" style="padding:20px 0;"><a href="https://nectforma.com/messagerie" style="background:linear-gradient(135deg,#C084FC,#A78BFA);color:#fff;text-decoration:none;padding:14px 32px;border-radius:8px;font-weight:600;">Lire le message</a></td></tr></table></td></tr><tr><td style="background:#F9FAFB;padding:24px 40px;border-radius:0 0 12px 12px;border-top:1px solid #E5E7EB;text-align:center;"><p style="color:#6B7280;font-size:13px;margin:0;">© ${new Date().getFullYear()} NECTFORMA</p></td></tr></table></td></tr></table></body></html>`;
}
