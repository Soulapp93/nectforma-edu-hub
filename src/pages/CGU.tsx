        ...
        <div className="prose prose-lg max-w-none">
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              ...
              et conditions d'utilisation de la plateforme NECTFORMA (ci-après "la Plateforme"), ainsi que les droits 
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              NECTFORMA met en œuvre tous les moyens raisonnables à sa disposition pour assurer un accès 
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
              ...
              <li>Informer immédiatement NECTFORMA de toute utilisation non autorisée de son compte</li>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              ...
              sont la propriété exclusive de NECTFORMA ou de ses partenaires et sont protégés par les lois 
              françaises et internationales relatives à la propriété intellectuelle.
            </p>
            <p className="text-gray-700 leading-relaxed">
              Toute reproduction, représentation, modification, publication, adaptation de tout ou partie 
              des éléments de la Plateforme, quel que soit le moyen ou le procédé utilisé, est interdite, 
              sauf autorisation écrite préalable de NECTFORMA.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              NECTFORMA s'engage à respecter la réglementation applicable en matière de protection des données 
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              NECTFORMA se réserve le droit de modifier les présentes CGU à tout moment. Les utilisateurs 
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              ...
              ou en contactant le support NECTFORMA.
            </p>
            <p className="text-gray-700 leading-relaxed">
              NECTFORMA se réserve le droit de suspendre ou de supprimer le compte d'un utilisateur 
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              <a href="mailto:contact@nectforma.com" className="text-primary hover:underline ml-1">
                contact@nectforma.com
              </a>
            </p>
          </section>
        </div>
