        ...
        <div className="w-full px-3 sm:px-4 lg:px-6 py-3 sm:py-4">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0 flex-1">
              <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-foreground">Documents & Archives</h1>
              <p className="text-xs sm:text-sm text-muted-foreground mt-0.5">Dossiers étudiants et archives de l'établissement.</p>
            </div>
          </div>
        </div>
