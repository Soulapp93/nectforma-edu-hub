  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border-2 border-primary/30 bg-background hover:bg-primary/5 hover:border-primary/50 text-foreground active:scale-[0.98]",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/80 shadow-sm active:scale-[0.98]",
        ghost: "hover:bg-accent/10 hover:text-accent-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        // Digiforma-inspired variants
        accent: "bg-accent text-accent-foreground hover:bg-accent/90 shadow-sm hover:shadow-md active:scale-[0.98]",
        gradient: "bg-gradient-to-r from-primary to-[hsl(280,55%,52%)] text-white hover:opacity-90 shadow-md hover:shadow-lg active:scale-[0.98]",
        success: "bg-success text-success-foreground hover:bg-success/90 shadow-sm hover:shadow-md active:scale-[0.98]",
        premium: "bg-gradient-to-r from-primary to-[hsl(280,55%,52%)] text-white hover:opacity-90 shadow-md hover:shadow-lg active:scale-[0.98]",
        elegant: "bg-primary/10 text-primary hover:bg-primary/20 border border-primary/20 active:scale-[0.98]",
