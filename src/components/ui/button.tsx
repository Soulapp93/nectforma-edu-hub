...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-all duration-300 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.97]",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground shadow-md hover:bg-primary-hover hover:shadow-lg hover:-translate-y-0.5",
        ...
        info: "bg-info text-info-foreground shadow-md hover:bg-info/90 hover:shadow-lg",
        gradient: "bg-gradient-to-r from-primary via-primary to-primary text-primary-foreground shadow-primary hover:shadow-glow hover:-translate-y-0.5",
        premium: "bg-gradient-to-r from-primary to-info text-primary-foreground shadow-primary hover:shadow-glow hover:-translate-y-0.5",
        elegant: "bg-card text-card-foreground border-2 border-border hover:bg-muted hover:border-primary/30 shadow-sm hover:shadow-md"
      },
      size: {
