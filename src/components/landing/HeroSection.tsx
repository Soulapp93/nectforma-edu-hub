...
import {
  BookOpen, GraduationCap, Pencil, PenTool, Lightbulb, Star, Award, FileText,
  Sparkles, ArrowRight, Play, Download, CheckCircle2, Shield, Zap
} from 'lucide-react';
...
interface HeroSectionProps {
  tableauDeBordImg: string;
  emargement1Img: string;
  emploisTempsImg: string;
}

const HeroSection: React.FC<HeroSectionProps> = ({ tableauDeBordImg, emargement1Img, emploisTempsImg }) => {
  return (
    <>
      {/* Hero Section */}
