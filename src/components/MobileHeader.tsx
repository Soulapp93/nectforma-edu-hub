...
const MobileHeader = () => {
  ...
  const mainPages = ['/dashboard', '/formations', '/emploi-temps', '/messagerie', '/groupes', '/administration', '/compte', '/pedagogie', '/suivi-emargement-admin', '/notes-admin', '/communication', '/documents-archives', '/espace-travail', '/gestion-etablissement', '/suivi-emargement', '/notes', '/classes-virtuelles'];
